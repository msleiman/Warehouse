			...
			if ( $( this ).hasClass( 'quickviewbutton' ) ) {
				...
				setTimeout(function(){
					var refreshInterval = setInterval(function(){
						if ( $('select.variation-select.va-size-select.selectBox option:selected').text().trim() == 'Size') {
							// Do nothing
						}

						else {
							clearInterval(refreshInterval);
							$('.action-addtocart.product-action.add-to-cart.button_primary').click(function(){
